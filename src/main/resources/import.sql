...
INSERT INTO USER (ID, USERID, PASSWORD, NAME, EMAIL, CREATE_DATE) VALUES (4, 'isel', '1234', 'Handong Kim', '12121@handong.edu', CURRENT_TIMESTAMP());

INSERT INTO QUESTION (id, writer_id, title, contents, create_date, count_of_answer) VALUES (1, 1, '[전산전자공학부] 데이터 구조 (2분반)', '데이터구조 2분반 김영섭교수님 수업듣는 분들 중 스터디 같이하실 분 모집합니다! 함께하실 분 댓글로 메일주소를 알려주세요~  (4명까지 받을 예정)', CURRENT_TIMESTAMP(), 0);
...
INSERT INTO QUESTION (id, writer_id, title, contents, create_date, count_of_answer) VALUES (2, 2, '[경영경제학부] 경영경제통계 (1분반)', '경경통 김우성교수님 1분반 스터디 같이 하실분 모집합니다. 댓글로 메일을 남겨주세요. ', CURRENT_TIMESTAMP(), 0);
INSERT INTO QUESTION (id, writer_id, title, contents, create_date, count_of_answer) VALUES (5, 2, '[경영경제학부] 경영경제통계 (1분반)', '경경통 김우성교수님 1분반 스터디 같이 하실분 모집합니다. 댓글로 메일을 남겨주세요. ', CURRENT_TIMESTAMP(), 0);
